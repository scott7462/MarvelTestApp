package scott.android.com.marveltest.app.ui.launch;
...
import scott.android.com.marveltest.app.ui.login.LoginActivity;
        ...
        addSubscription(Observable.timer(2, TimeUnit.SECONDS)
                ...
                .subscribe(new Action1<Long>() {
                    ...
                    public void call(Long aLong) {
                        if (PreferenceUtils.isAuth()) {
                            ActivityMain.newInstance(ActivityLaunch.this);
                        } else {
                            LoginActivity.newInstance(ActivityLaunch.this);
                        }
                        finish();
                    }
                }));
